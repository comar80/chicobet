...
import { Box, TextField, Button, Typography, Grid, Paper, Container, Card } from "@mui/material";
                ...
                <Grid container spacing={2}>
                    {messages.length === 0 ? (
                        ...
                        messages.map((msg, idx) => (
                            <Grid size={{ xs: 12, sm: 12, md: 6 }} key={msg._id || idx}>
                                <Paper sx={{
                                    p: 2,
                                    minHeight: { sm: 120, md: 280, lg: 220 },
                                    display: "flex",
