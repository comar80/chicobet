...
function SendResetPasswordLink() {
    ...
    const handleResetPassword = async (e) => {
        ...
        try {
            ...
            console.log("Email de redefinição reenviado:", response.data);

            toast.success("Email enviado! Acesse seu email para redefinir a senha. Cheque o Spam caso não encontre na caixa de entrada", {
                position: "top-right",
                autoClose: 10000,
                        ...
                        >
                            <Grid item xs={11} sm={9} md={5} lg={4} xl={3} >
                                ...
                                >
                                    ...
                                    >
                                        Um link será enviado para seu email. Cheque a caixa de spam caso não encontre na caixa de entrada
                                    </MKTypography>
